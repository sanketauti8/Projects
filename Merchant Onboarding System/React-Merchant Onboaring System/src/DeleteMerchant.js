...
const DeleteMerchant = () => {
  ...
  return (
    ...
    <form class="ui fluid form" onSubmit={handleSubmit}>
        <h2>Add a Product</h2>
        <label htmlFor="Contact">Enter Contact No for which you want to Delete:</label>
        <input placeholder="Enter Contact No"  type="text" value={inputValue} onChange={handleInput} />

      <button class="ui red basic button" type="submit">Delete Merchant</button>
    </form>
      {showSuccess && (
        <div className="success-popup">
          <p>Merchant Deleted successfully!</p>
