...
class Todo(db.Model):
    ...
    user_id=db.Column(db.Integer)#same as User table we can add foreign key also
#python    // we are creating tables in DB by using this commands
#from todoApi import db
#db.create_all()
#exit()

#checking if its created or not
#sqlite3 todo.db
#.tables
#.exit
